...
def create_conservative_debator(llm):
    ...
    def conservative_node(state) -> dict:
        ...
        prompt = f"""As the Conservative Risk Analyst, write one independent downside/protection scenario memo for the Portfolio Manager. This is not a debate. Do not rebut other risk analysts and do not ask for another round. Focus on capital protection, drawdown risk, liquidity stress, and the evidence that would justify staying defensive.
...
Make the memo concrete and decision-useful. Preserve price levels, risk thresholds, and evidence caveats when available.""" + get_language_instruction()
        ...
        argument = f"Conservative Risk Scenario: {response}"
